...
public class GuiOptions extends JFrame {
    ...
    private gj BASELINE; /*MC BASECLASS*/
    ...
    private boolean BASELINE() {
        return (this.BASELINE.e == null || this.BASELINE.g == null || this.BASELINE.g.e == null) ? false : true;
    }
    ...
    private void addMouseListener(ActionEvent var1) {
        if (this.setSelected.getSelectedIndex() >= 0) {
            ...
            bq bqVar = this.BASELINE.g;
            bq bqVar2 = this.BASELINE.g;
            this.BASELINE.g.av = 0.0d;
            bqVar2.au = 0.0d;
            bqVar.at = 0.0d;
        }
    }
    ...
    private void addPreferredGap(ActionEvent var1) {
        ...
        this.aB.add(new Teleport(var22, this.BASELINE.g.aw, this.BASELINE.g.ax, this.BASELINE.g.ay));
